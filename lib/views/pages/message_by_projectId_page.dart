...
class MessageByProjectIdPage extends StatefulWidget {
  final User user;
  final int projectId;

  const MessageByProjectIdPage(
      {required this.user, required this.projectId, Key? key})
      : super(key: key);

  @override
  _MessageByProjectIdPageState createState() => _MessageByProjectIdPageState();
}

class _MessageByProjectIdPageState extends State<MessageByProjectIdPage> {
      ...
      if (mounted) {
        setState(() {
          for (int i = 0; i < value.length; i++) {
            if (value[i].project!.id == widget.projectId) {
