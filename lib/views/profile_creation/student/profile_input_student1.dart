...
class _ProfileInputStudent1State extends State<ProfileInputStudent1> {
  ...
  void _addNewLanguage(String language, String level) {
    setState(() {
      print("ID: ${widget.user.id}, ${'settingscreen_ProfileCreation5'.tr()} $language, ${'settingscreen_ProfileCreation6'.tr()} $level");
  ...
  void _addNewEducation(String schoolName, int yearsStart, int yearsEnd) {
    setState(() {
      print(
          "ID: ${widget.user.id}, ${'settingscreen_ProfileCreation7'.tr()} $schoolName, ${'settingscreen_ProfileCreation8'.tr()} $yearsStart, ${'settingscreen_ProfileCreation9'.tr()} $yearsEnd");
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(
                  "studentprofileinput1_ProfileCreation2".tr(),
                  style: GoogleFonts.poppins(
                    fontSize: 17,
                    fontWeight: FontWeight.bold,
                  ),
            ...
            Container(
              ...
              child: DropdownSearch<TechStack>(
                ...
                dropdownBuilder: (context, selectedItem) {
                  return Text(
                    selectedItem?.name ?? "studentprofileinput1_ProfileCreation5".tr(),
                    style: GoogleFonts.poppins(
                      fontSize: 13,
                      color: Colors.grey,
                    ),
                ...
                onChanged: (TechStack? newValue) {
                  setState(() {
                    ...
                    print("${'settingscreen_ProfileCreation11'.tr()}: $_selectedTechStack");
              ...
              child: Padding(
                ...
                child: FadeTransition(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      print(
                          "${'studentprofileinput1_ProfileCreation2'.tr()}: $_selectedTechStackId - $_selectedTechStack");
                      for (var i = 0; i < _selectedSkills.length; i++) {
                        print(
                            "${'studentprofileinput4_ProfileEdit3'.tr()}: ${_selectedSkillSet[i].id} - ${_selectedSkillSet[i].name}");
                      }
                      for (var i = 0; i < languages.length; i++) {
                        print(
                            "${'switchaccount4'.tr()}: ${languages[i].languageName} - ${languages[i].level}");
                      }
