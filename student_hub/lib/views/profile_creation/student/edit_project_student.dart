...
class EditProjectInputStudent extends StatefulWidget {
  final User user;
  const EditProjectInputStudent(this.user, {super.key});

  @override
  _EditProjectInputStudentState createState() => _EditProjectInputStudentState();
}

class _EditProjectInputStudentState extends State<EditProjectInputStudent> {
